	...
	protected function testRunEnd(\mageekguy\tests\unit\test $test)
	{
		...
		if ($exceptionNumber > 0)
		{
			...
			foreach ($score->getExceptions() as $exception)
			{
				...
				self::write(sprintf($this->locale->_('Exception %s with message \'%s\' generated by file %s at line %d'), get_class($exception['value']), $exception['value']->getMessage(), $exception['file'], $exception['line']), 2);
			}
		}
