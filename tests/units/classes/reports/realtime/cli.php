		...
		$this->assert
			->array($report->getRunnerFields(atoum\runner::runStart))->isEqualTo(array(
					...
					new fields\runner\php\version\cli(
						new prompt('> '),
						new colorizer('1;36;38;5;117'),
						new prompt('=> ', new colorizer('1;36;38;5;117'))
					)
				)
			)
			->array($report->getRunnerFields(atoum\runner::runStop))->isEqualTo(array(
					...
					new fields\runner\failures\cli(
						new prompt('> '),
						new colorizer('0;31;38;5;160'),
						new prompt('=> ', new colorizer('0;31;38;5;160'))
					),
					...
					new fields\runner\errors\cli(
						new prompt('> '),
						new colorizer('0;33;38;5;220'),
						new prompt('=> ', new colorizer('0;33;38;5;220')),
						null,
						new prompt('==> ', new colorizer('0;33;38;5;220'))
					),
					new fields\runner\exceptions\cli(
						new prompt('> '),
						new colorizer('0;35;38;5;135'),
						new prompt('=> ', new colorizer('0;35;38;5;135')),
						null,
						new prompt('==> ', new colorizer('0;35;38;5;135'))
					)
				)
