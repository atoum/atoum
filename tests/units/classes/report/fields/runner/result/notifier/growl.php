	...
	public function testNotify()
	{
		$this
			...
			->then
				...
				->adapter($adapter)
					->call('system')->withArguments(sprintf('growlnotify --title %s --name atoum --message %s --image %s', escapeshellarg('Success !'), escapeshellarg($successString), escapeshellarg(realpath(__DIR__ . '/../../../../../../../../resources/images/logo_success.png'))))->once()
			...
			->then
				...
				->adapter($adapter)
					->call('system')->withArguments(sprintf('growlnotify --title %s --name atoum --message %s --image %s', escapeshellarg('Failure !'), escapeshellarg($failureString), escapeshellarg(realpath(__DIR__ . '/../../../../../../../../resources/images/logo_fail.png'))))->once()
