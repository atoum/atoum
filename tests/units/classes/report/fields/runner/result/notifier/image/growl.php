	...
	public function testNotify()
	{
		$this
			...
			->then
				...
				->adapter($adapter)
					->call('system')->withArguments(sprintf('growlnotify --title %s --name atoum --message %s --image %s --url \'\'', escapeshellarg('Success!'), escapeshellarg($successString), escapeshellarg($image)))->once()
