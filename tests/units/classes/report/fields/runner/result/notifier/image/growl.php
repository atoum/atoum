	...
	public function testNotify()
	{
		$this
			...
			->then
				...
				->adapter($adapter)
					->call('system')->withArguments(sprintf('growlnotify --title %s --name atoum --message %s --image %s', escapeshellarg('Success !'), escapeshellarg($successString), escapeshellarg($image)))->once()
			...
			->then
				...
				->adapter($adapter)
					->call('system')->withArguments(sprintf('growlnotify --title %s --name atoum --message %s --image %s', escapeshellarg('Failure !'), escapeshellarg($failureString), escapeshellarg($image)))->once()
