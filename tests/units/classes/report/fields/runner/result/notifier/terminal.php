	...
	public function testNotify()
	{
		$this
			...
			->then
				...
				->mock($field)
					->call('execute')->withArguments('terminal-notifier -title %s -message %s', array('Success !', $successString))->once()
			...
			->then
				...
				->mock($field)
					->call('execute')->withArguments('terminal-notifier -title %s -message %s', array('Failure !', $failureString))->once()
