...
class cli extends units\report\fields\runner
{
	...
	public function test__toString()
	{
		...
		$this->assert('There is errors with file, line and no case')
		...
		$this->assert('There is errors with file, line and case')
			->castToString($defaultField-> setWithRunner($runner))->isEqualTo(sprintf('There are %d errors:', sizeof($allErrors)) . PHP_EOL .
				$class . '::' . $method . '():' . PHP_EOL .
		...
		$this->assert('There is errors with no file, no line and no case')
		...
		$this->assert('There is errors with no file, no line and case')
			->castToString($defaultField-> setWithRunner($runner))->isEqualTo(sprintf('There is %d error:', sizeof($allErrors)) . PHP_EOL .
				$class . '::' . $method . '():' . PHP_EOL .
		...
		$this->assert('There is errors with no file, line and no case')
			->castToString($defaultField-> setWithRunner($runner))->isEqualTo(sprintf('There is %d error:', sizeof($allErrors)) . PHP_EOL .
				$class . '::' . $method . '():' . PHP_EOL .
				sprintf('Error %s in unknown file on unknown line, generated by file %s on line %d:', strtoupper($type), $errorFile, $errorLine) . PHP_EOL .
				$message . PHP_EOL
		...
		$this->assert('There is errors with file, no line, no error file, no error line and a case')
			->castToString($defaultField-> setWithRunner($runner))->isEqualTo(sprintf('There is %d error:', sizeof($allErrors)) . PHP_EOL .
				$class . '::' . $method . '():' . PHP_EOL .
		...
		$this->assert('There is errors with no file, line and case')
			->castToString($defaultField-> setWithRunner($runner))->isEqualTo(sprintf('There is %d error:', sizeof($allErrors)) . PHP_EOL .
				$class . '::' . $method . '():' . PHP_EOL .
				sprintf('Error %s in unknown file on unknown line, generated by file %s on line %d in case \'%s\':', strtoupper($type), $errorFile, $errorLine, $case) . PHP_EOL .
				$message . PHP_EOL
		...
		$this->assert('There is errors with file, no line and no case')
			->castToString($defaultField-> setWithRunner($runner))->isEqualTo(sprintf('There is %d error:', sizeof($allErrors)) . PHP_EOL .
				$class . '::' . $method . '():' . PHP_EOL .
		...
		$this->assert('There is errors with file, no line and case')
			->castToString($defaultField-> setWithRunner($runner))->isEqualTo(sprintf('There is %d error:', sizeof($allErrors)) . PHP_EOL .
				$class . '::' . $method . '():' . PHP_EOL .
