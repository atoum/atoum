        ...
        $this
            ->assert('Use r and r+ mode')
                ...
                ->then
                    ...
                    ->mock($calls)->call('addCall')->withArguments(new test\adapter\call('stream_open', [$path, 'z', 0]))->once()
                    ->boolean($controller->stream_open($path = uniqid(), 'z', STREAM_REPORT_ERRORS))->isFalse()
                    ->mock($calls)->call('addCall')->withArguments(new test\adapter\call('stream_open', [$path, 'z', STREAM_REPORT_ERRORS]))->once()
                    ->error('Operation timed out', E_USER_WARNING)->exists()
                    ->boolean($controller->stream_open($path = uniqid(), 'r', 0))->isTrue()
                    ->mock($calls)->call('addCall')->withArguments(new test\adapter\call('stream_open', [$path, 'r', 0]))->once()
                    ...
                    ->mock($calls)->call('addCall')->withArguments(new test\adapter\call('stream_open', [$path, 'r', STREAM_USE_PATH, null]))->once()
                    ->string($usePath)->isEqualTo($controller->getPath())
                    ->boolean($controller->stream_open($path = uniqid(), 'r+', STREAM_USE_PATH, $usePath))->isTrue()
                    ->mock($calls)->call('addCall')->withArguments(new test\adapter\call('stream_open', [$path, 'r+', STREAM_USE_PATH, $usePath]))->once()
                    ->string($usePath)->isEqualTo($controller->getPath())
                ...
                ->then
                    ...
                    ->mock($calls)->call('addCall')->withArguments(new test\adapter\call('stream_open', [$path, 'r', STREAM_REPORT_ERRORS]))->once()
                ...
                ->then
                    ->boolean($controller->stream_open($path = uniqid(), 'r+', STREAM_USE_PATH, $usePath))->isFalse()
                    ->mock($calls)->call('addCall')->withArguments(new test\adapter\call('stream_open', [$path, 'r+', STREAM_USE_PATH, $oldUsePath]))->once()
                    ->variable($usePath)->isNull()
            ->assert('Use w and w+ mode')
                ...
                ->then
                    ...
                    ->mock($calls)->call('addCall')->withArguments(new test\adapter\call('stream_open', [$path, 'w', 0]))->once()
                    ->integer($controller->stream_tell())->isZero()
                    ->boolean($controller->stream_read(1))->isFalse()
                    ->integer($controller->stream_write('a'))->isEqualTo(1)
                    ->boolean($controller->stream_open($path = uniqid(), 'w+', 0))->isTrue()
                    ->mock($calls)->call('addCall')->withArguments(new test\adapter\call('stream_open', [$path, 'w+', 0]))->once()
                    ->integer($controller->stream_tell())->isZero()
                    ...
                    ->mock($calls)->call('addCall')->withArguments(new test\adapter\call('stream_open', [$path, 'w', STREAM_USE_PATH, null]))->once()
                    ->string($usePath)->isEqualTo($controller->getPath())
                    ->boolean($controller->stream_open($path = uniqid(), 'w+', STREAM_USE_PATH, $usePath))->isTrue()
                    ->mock($calls)->call('addCall')->withArguments(new test\adapter\call('stream_open', [$path, 'w+', STREAM_USE_PATH, $usePath]))->once()
                    ->string($usePath)->isEqualTo($controller->getPath())
                ->if($controller->setContents('abcdefghijklmnopqrstuvwxyz'))
                ->then
                    ->boolean($controller->stream_open($path = uniqid(), 'w', 0))->isTrue()
                ...
                ->then
                    ...
                    ->mock($calls)->call('addCall')->withArguments(new test\adapter\call('stream_open', [$path, 'w', STREAM_REPORT_ERRORS]))->once()
                    ->error('Permission denied', E_USER_WARNING)->exists()
                    ->boolean($controller->stream_open($path = uniqid(), 'w+', 0))->isFalse()
                    ->mock($calls)->call('addCall')->withArguments(new test\adapter\call('stream_open', [$path, 'w+', 0]))->once()
                    ->boolean($controller->stream_open($path = uniqid(), 'w+', STREAM_REPORT_ERRORS))->isFalse()
            ...
            ->assert('Use c and c+ mode')
                ...
                ->then
                    ...
                    ->mock($calls)->call('addCall')->withArguments(new test\adapter\call('stream_open', [$path, 'c', 0]))->once()
                    ->integer($controller->stream_tell())->isZero()
                    ->boolean($controller->stream_read(1))->isFalse()
                    ->integer($controller->stream_write('a'))->isEqualTo(1)
                    ->boolean($controller->stream_open($path = uniqid(), 'c+', 0))->isTrue()
                    ...
                    ->mock($calls)->call('addCall')->withArguments(new test\adapter\call('stream_open', [$path, 'c', STREAM_USE_PATH, null]))->once()
                    ->string($usePath)->isEqualTo($controller->getPath())
                    ->boolean($controller->stream_open($path = uniqid(), 'c+', STREAM_USE_PATH, $usePath))->isTrue()
                    ->mock($calls)->call('addCall')->withArguments(new test\adapter\call('stream_open', [$path, 'c+', STREAM_USE_PATH, $usePath]))->once()
                    ->string($usePath)->isEqualTo($controller->getPath())
                ->if($controller->setContents('abcdefghijklmnopqrstuvwxyz'))
                ->then
                    ->boolean($controller->stream_open($path = uniqid(), 'c', 0))->isTrue()
                ...
                ->then
                    ...
                    ->mock($calls)->call('addCall')->withArguments(new test\adapter\call('stream_open', [$path, 'c+', 0]))->once()
                    ->boolean($controller->stream_open($path = uniqid(), 'c+', STREAM_REPORT_ERRORS))->isFalse()
                    ->mock($calls)->call('addCall')->withArguments(new test\adapter\call('stream_open', [$path, 'c+', STREAM_REPORT_ERRORS]))->once()
                    ->error('Permission denied', E_USER_WARNING)->exists()
            ->assert('Use a and a+ mode')
                ...
                ->then
                    ...
                    ->mock($calls)->call('addCall')->withArguments(new test\adapter\call('stream_open', [$path, 'a+', STREAM_REPORT_ERRORS]))->once()
                    ->error('Permission denied', E_USER_WARNING)->exists()
            ->assert('Use x and x+ mode')
                ...
                ->then
                    ...
                    ->mock($calls)->call('addCall')->withArguments(new test\adapter\call('stream_open', [$path, 'x', STREAM_REPORT_ERRORS]))->once()
