	...
	public function testStreamOpen()
	{
		$this
			->assert('Use r and r+ mode')
				->if($controller = new testedClass(uniqid()))
				->then
					->boolean($controller->stream_open(uniqid(), 'z', 0))->isFalse()
					->array($controller->getCalls())->isNotEmpty()
					->boolean($controller->stream_open(uniqid(), 'z', STREAM_REPORT_ERRORS))->isFalse()
					->error('Operation timed out', E_USER_WARNING)->exists()
					->boolean($controller->stream_open(uniqid(), 'r', 0))->isTrue()
					...
					->boolean($controller->stream_open(uniqid(), 'r', STREAM_USE_PATH, $path))->isTrue()
				...
				->if($controller->notExists())
				->then
					->boolean($controller->stream_open(uniqid(), 'r', 0))->isFalse()
					->array($controller->getCalls())->isNotEmpty()
					->boolean($controller->stream_open(uniqid(), 'r+', 0))->isFalse()
					->boolean($controller->stream_open(uniqid(), 'r', STREAM_REPORT_ERRORS))->isFalse()
					->error('No such file or directory', E_USER_WARNING)->exists()
					->boolean($controller->stream_open(uniqid(), 'r+', STREAM_REPORT_ERRORS))->isFalse()
					->error('No such file or directory', E_USER_WARNING)->exists()
					->boolean($controller->stream_open(uniqid(), 'r+', 0))->isFalse()
					->boolean($controller->stream_open(uniqid(), 'r', STREAM_USE_PATH, $path))->isFalse()
			...
			->assert('Use w and w+ mode')
				...
				->then
					...
					->string($controller->stream_read(1))->isEmpty()
					->integer($controller->stream_write('a'))->isEqualTo(1)
					->boolean($controller->stream_open(uniqid(), 'w', STREAM_USE_PATH, $path))->isTrue()
					->string($path)->isEqualTo($controller->getPath())
					->boolean($controller->stream_open(uniqid(), 'w+', STREAM_USE_PATH, $path))->isTrue()
					->string($path)->isEqualTo($controller->getPath())
				->if($controller->setContents('abcdefghijklmnopqrstuvwxyz'))
				...
				->then
					...
					->array($controller->getCalls())->isNotEmpty()
					->boolean($controller->stream_open(uniqid(), 'w', STREAM_REPORT_ERRORS))->isFalse()
					->error('Permission denied', E_USER_WARNING)->exists()
					->boolean($controller->stream_open(uniqid(), 'w+', 0))->isFalse()
					->boolean($controller->stream_open(uniqid(), 'w+', STREAM_REPORT_ERRORS))->isFalse()
					->error('Permission denied', E_USER_WARNING)->exists()
			->assert('Use c and c+ mode')
				...
				->then
					...
					->string($controller->stream_read(1))->isEqualTo('a')
					->integer($controller->stream_write('a'))->isEqualTo(1)
					->boolean($controller->stream_open(uniqid(), 'c', STREAM_USE_PATH, $path))->isTrue()
					->string($path)->isEqualTo($controller->getPath())
					->boolean($controller->stream_open(uniqid(), 'c+', STREAM_USE_PATH, $path))->isTrue()
					->string($path)->isEqualTo($controller->getPath())
				->if($controller->setContents('abcdefghijklmnopqrstuvwxyz'))
				...
				->then
					...
					->array($controller->getCalls())->isNotEmpty()
					->boolean($controller->stream_open(uniqid(), 'c', STREAM_REPORT_ERRORS))->isFalse()
					->error('Permission denied', E_USER_WARNING)->exists()
					->boolean($controller->stream_open(uniqid(), 'c+', 0))->isFalse()
					->boolean($controller->stream_open(uniqid(), 'c+', STREAM_REPORT_ERRORS))->isFalse()
					->error('Permission denied', E_USER_WARNING)->exists()
			->assert('Use a and a+ mode')
				...
				->then
					...
					->array($controller->getCalls())->isNotEmpty()
					->boolean($controller->stream_open(uniqid(), 'a+', 0))->isFalse()
					->boolean($controller->stream_open(uniqid(), 'a+', STREAM_REPORT_ERRORS))->isFalse()
					->error('Permission denied', E_USER_WARNING)->exists()
			->assert('Use x and x+ mode')
				->if($controller = new testedClass(uniqid()))
				->then
					->boolean($controller->stream_open(uniqid(), 'x', 0))->isFalse()
					->array($controller->getCalls())->isNotEmpty()
					->boolean($controller->stream_open(uniqid(), 'x', STREAM_REPORT_ERRORS))->isFalse()
				...
				->if($controller->notExists())
				->then
					->boolean($controller->stream_open(uniqid(), 'x', 0))->isTrue()
					->array($controller->getCalls())->isNotEmpty()
					->integer($controller->stream_tell())->isZero()
					->string($controller->stream_read(1))->isEmpty()
