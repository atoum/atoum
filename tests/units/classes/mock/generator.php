...
class generator extends atoum\test
{
	...
	public function testGetMockedClassCodeForRealClass()
	{
		$this
			...
			->and($reflectionMethodController->controlNextNewMock())
			...
			->and($reflectionClassController->controlNextNewMock())
	...
	public function testGetMockedClassCodeWithProtectedAbstractMethod()
	{
		$this
			...
			->and($publicMethodController->controlNextNewMock())
			...
			->and($protectedMethodController->controlNextNewMock())
			...
			->and($classController->controlNextNewMock())
