...
class controller extends atoum\test
{
	...
	public function test__get()
	{
		...
		$this->assert
			->object($streamController->__construct)->isEqualTo(new test\adapter\caller())
			->object($streamController->dir_closedir)->isEqualTo(new test\adapter\caller())
			->object($streamController->closedir)->isEqualTo(new test\adapter\caller())
			->object($streamController->dir_opendir)->isEqualTo(new test\adapter\caller())
			->object($streamController->opendir)->isEqualTo(new test\adapter\caller())
			->object($streamController->dir_readdir)->isEqualTo(new test\adapter\caller())
			->object($streamController->readdir)->isEqualTo(new test\adapter\caller())
			->object($streamController->dir_rewinddir)->isEqualTo(new test\adapter\caller())
			->object($streamController->rewinddir)->isEqualTo(new test\adapter\caller())
			->object($streamController->mkdir)->isEqualTo(new test\adapter\caller())
			->object($streamController->rename)->isEqualTo(new test\adapter\caller())
			->object($streamController->rmdir)->isEqualTo(new test\adapter\caller())
			->object($streamController->stream_cast)->isEqualTo(new test\adapter\caller())
			->object($streamController->select)->isEqualTo(new test\adapter\caller())
			->object($streamController->stream_close)->isEqualTo(new test\adapter\caller())
			->object($streamController->fclose)->isEqualTo(new test\adapter\caller())
			->object($streamController->stream_eof)->isEqualTo(new test\adapter\caller())
			->object($streamController->feof)->isEqualTo(new test\adapter\caller())
			->object($streamController->stream_flush)->isEqualTo(new test\adapter\caller())
			->object($streamController->fflush)->isEqualTo(new test\adapter\caller())
			->object($streamController->stream_lock)->isEqualTo(new test\adapter\caller())
			->object($streamController->flock)->isEqualTo(new test\adapter\caller())
			->object($streamController->stream_metadata)->isEqualTo(new test\adapter\caller())
			->object($streamController->touch)->isEqualTo(new test\adapter\caller())
			->object($streamController->chmod)->isEqualTo(new test\adapter\caller())
			->object($streamController->chown)->isEqualTo(new test\adapter\caller())
			->object($streamController->chgrp)->isEqualTo(new test\adapter\caller())
			->object($streamController->stream_open)->isEqualTo(new test\adapter\caller())
			->object($streamController->fopen)->isEqualTo(new test\adapter\caller())
			->object($streamController->stream_read)->isEqualTo(new test\adapter\caller())
			->object($streamController->fread)->isEqualTo(new test\adapter\caller())
			->object($streamController->stream_seek)->isEqualTo(new test\adapter\caller())
			->object($streamController->fseek)->isEqualTo(new test\adapter\caller())
			->object($streamController->stream_set_option)->isEqualTo(new test\adapter\caller())
			->object($streamController->stream_stat)->isEqualTo(new test\adapter\caller())
			->object($streamController->fstat)->isEqualTo(new test\adapter\caller())
			->object($streamController->stream_tell)->isEqualTo(new test\adapter\caller())
			->object($streamController->ftell)->isEqualTo(new test\adapter\caller())
			->object($streamController->stream_write)->isEqualTo(new test\adapter\caller())
			->object($streamController->fwrite)->isEqualTo(new test\adapter\caller())
			->object($streamController->unlink)->isEqualTo(new test\adapter\caller())
			->object($streamController->url_stat)->isEqualTo(new test\adapter\caller())
			->object($streamController->stat)->isEqualTo(new test\adapter\caller())
		;
