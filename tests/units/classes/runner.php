	...
	public function test__construct()
	{
		$this
			...
			->then
				...
				->object($defaultGlobIterator = $defaultGlobIteratorFactory($pattern = sys_get_temp_dir()))->isInstanceOf('globIterator')
				->string($defaultGlobIterator->getPathName())->isEqualTo($pattern)
