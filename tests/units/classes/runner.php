...
class runner extends atoum\test
{
	...
	public function testCanAddTest()
	{
		$this
			...
			->then
				...
				->array($runner->getDeclaredTestClasses())->isEmpty()
			->if(eval('namespace ' . __NAMESPACE__ . ' { class forTestCanAddTest1 extends \mageekguy\atoum\test { public function testSomething() {} } }'))
			->and($adapter->get_declared_classes = array('mageekguy\atoum\tests\units\forTestCanAddTest1'))
			->then
				->object($runner->canAddTest())->isIdenticalTo($runner)
				->array($runner->getDeclaredTestClasses())->isEqualTo(array('mageekguy\atoum\tests\units\forTestCanAddTest1'))
			->if($runner->canNotAddTest())
			->and(eval('namespace ' . __NAMESPACE__ . ' { class forTestCanAddTest2 extends \mageekguy\atoum\test { public function testSomething() {} } }'))
			->and($adapter->get_declared_classes = array('mageekguy\atoum\tests\units\forTestCanAddTest1', 'mageekguy\atoum\tests\units\forTestCanAddTest2'))
			->then
				->object($runner->canAddTest())->isIdenticalTo($runner)
				->array($runner->getDeclaredTestClasses())->isEqualTo(array('mageekguy\atoum\tests\units\forTestCanAddTest1', 'mageekguy\atoum\tests\units\forTestCanAddTest2'))
		;
	}
	...
	public function testCanNotAddTest()
	{
		$this
			...
			->then
				->array($runner->getDeclaredTestClasses())->isEqualTo(array('mageekguy\atoum\tests\units\forTestCanAddTest1'))
			->if(eval('namespace ' . __NAMESPACE__ . ' { class forTestCanAddTest2 extends \mageekguy\atoum\test { public function testSomething() {} } }'))
			->and($adapter->get_declared_classes = array('mageekguy\atoum\tests\units\forTestCanAddTest1', 'mageekguy\atoum\tests\units\forTestCanAddTest2'))
			->then
				->array($runner->getDeclaredTestClasses())->isEqualTo(array('mageekguy\atoum\tests\units\forTestCanAddTest1'))
		;
