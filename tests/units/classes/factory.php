	...
	public function testImport()
	{
		$this->assert
			...
			->then
				...
				->array($factory->getImportations())->isEqualTo(array(null => array('foo' => 'foo')))
				->object($factory->import('\foo'))->isIdenticalTo($factory)
				->array($factory->getImportations())->isEqualTo(array(null => array('foo' => 'foo')))
				->object($factory->import('foo', 'bar'))->isIdenticalTo($factory)
				->array($factory->getImportations())->isEqualTo(array(null => array('foo' => 'foo', 'bar' => 'foo')))
				->object($factory->import('foo\bar', 'truc'))->isIdenticalTo($factory)
				->array($factory->getImportations())->isEqualTo(array(null => array('foo' => 'foo', 'bar' => 'foo', 'truc' => 'foo\bar')))
				->object($factory->import('foo\bar\toto', 'tutu'))->isIdenticalTo($factory)
				->array($factory->getImportations())->isEqualTo(array(null => array('foo' => 'foo', 'bar' => 'foo', 'truc' => 'foo\bar', 'tutu' => 'foo\bar\toto')))
