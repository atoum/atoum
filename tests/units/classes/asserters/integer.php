...
class integer extends atoum\test
{
	...
	{
		$asserter = new asserters\integer($score = new atoum\score(), $locale = new atoum\locale(), $generator = new asserter\generator($this));
	...
	public function testSetWith()
	{
		...
		$asserter = new asserters\integer($score = new atoum\score(), $locale = new atoum\locale(), new asserter\generator($this));
