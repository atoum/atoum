...
class string extends variable
{
	...
	{
		return $this->_isHash(40, $failMessage);
	}

	public function isSha256($failMessage = null)
	{
		return $this->_isHash(64, $failMessage);
	}

	public function isSha512($failMessage = null)
	{
		return $this->_isHash(128, $failMessage);
	}

	public function isMd5($failMessage = null)
	{
		return $this->_isHash(32, $failMessage);
	}

	protected function _isHash($length, $failMessage = null)
	{
