					...
					else
					{
						switch (true)
						{
							case $error['file'] === null:
								...
								{
									case $error['errorFile'] === null:
										$errorMessage = sprintf($this->locale->_('Error %s in unknown file on unknown line %s, generated by unknown file'), $type, $error['case']);
										break;

									case $error['errorLine'] === null:
										$errorMessage = sprintf($this->locale->_('Error %s in unknown file on unknown line, generated by file %s %s'), $type, $error['errorFile'], $error['case']);
										break;

									case $error['errorLine'] !== null:
										$errorMessage = sprintf($this->locale->_('Error %s in unknown file on unknown line, generated by file %s on line %d %s'), $type, $error['errorFile'], $error['errorLine'], $error['case']);
										break;
								}
								break;
							...
							case $error['line'] === null:
								...
								{
									case $error['errorFile'] === null:
										$errorMessage = sprintf($this->locale->_('Error %s in %s on unknown line, generated by unknown file %s'), $type, $error['file'], $error['case']);
										break;

									case $error['errorLine'] === null:
										$errorMessage = sprintf($this->locale->_('Error %s in %s on unknown line, generated by file %s %s'), $type, $error['file'], $error['errorFile'], $error['case']);
										break;

									case $error['errorLine'] !== null:
										$errorMessage = sprintf($this->locale->_('Error %s in %s on unknown line, generated by file %s on line %d %s'), $type, $error['file'], $error['errorFile'], $error['errorLine'], $error['case']);
										break;
								}
								break;
							...
							default:
								...
								{
									case $error['errorFile'] === null:
										$errorMessage = sprintf($this->locale->_('Error %s in %s on line %d, generated by unknown file %s'), $type, $error['file'], $error['line'], $error['case']);
										break;

									case $error['errorLine'] === null:
										$errorMessage = sprintf($this->locale->_('Error %s in %s on line %d, generated by file %s %s'), $type, $error['file'], $error['line'], $error['errorFile'], $error['case']);
										break;

									case $error['errorLine'] !== null:
										$errorMessage = sprintf($this->locale->_('Error %s in %s on line %d, generated by file %s on line %d %s'), $type, $error['file'], $error['line'], $error['errorFile'], $error['errorLine'], $error['case']);
										break;
								}
								break;
						}
