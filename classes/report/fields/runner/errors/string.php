				...
				foreach ($errors as $error)
				{
					...
					switch (true)
					{
						...
						case $error['line'] === null:
							...
							{
								case $error['errorFile'] === null:
									$string .= sprintf($this->locale->_('Error %s on unknown line, generated by unknown file:'), $type, $error['file']);
									break;

								case $error['errorLine'] === null:
									$string .= sprintf($this->locale->_('Error %s on unknown line, generated by file %s:'), $type, $error['file'], $error['errorFile']);
									break;

								case $error['errorLine'] !== null:
									$string .= sprintf($this->locale->_('Error %s on unknown line, generated by file %s on line %d:'), $type, $error['file'], $error['errorFile'], $error['errorLine']);
									break;
							}
							break;
